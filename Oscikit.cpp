...
Oscikit::Oscikit(const InstanceInfo& info)
...
#if IPLUG_EDITOR
void Oscikit::OnMidiMsgUI(const IMidiMsg& msg)
{
...
#if IPLUG_DSP
void Oscikit::GetBusName(ERoute direction, int busIdx, int nBuses, WDL_String& str) const
{
...
void Oscikit::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void Oscikit::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void Oscikit::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void Oscikit::OnParamChange(int paramIdx)
{
  switch (paramIdx)
  {
...
bool Oscikit::GetMidiNoteText(int noteNumber, char* name) const
{
