...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Oscikit Demo Installer\n"
      else:
        line="OutputBaseFilename=Oscikit Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Oscikit Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Oscikit installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Oscikit Demo installer\n"
     else:
       line="SetupWindowTitle=Oscikit installer\n"
